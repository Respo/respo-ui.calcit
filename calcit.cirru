...
{} (:about "|Machine-generated snapshot. Do not edit directly — changes will be overwritten. Use `cr query` to inspect and `cr edit`/`cr tree` to modify. Run `cr docs agents --full` first. Manual edits must follow format and schema conventions, then run `cr edit format`.") (:package |respo-ui) (:version |0.6.5)
  ...
  :files $ {}
    |respo-ui.comp $ %{} :FileEntry
      :defs $ {}
        ...
        |comp-catoptric-text $ %{} :CodeEntry (:doc "|by \"catoptric text\" I mean text added with CSS content, thus unsearchable from browser search or select. The text can still be grabbed from DOM tree though.") (:schema :dynamic)
          ...
          :examples $ []
        |comp-checkbox $ %{} :CodeEntry (:doc |) (:schema :dynamic)
          :code $ quote
        ...
        |comp-cirru-snippet $ %{} :CodeEntry (:doc |) (:schema :dynamic)
          ...
          :examples $ []
        |comp-close $ %{} :CodeEntry (:doc |) (:schema :dynamic)
          :code $ quote
          ...
          :examples $ []
        |comp-copy $ %{} :CodeEntry (:doc |) (:schema :dynamic)
          :code $ quote
                          ...
                          tag-match item $
                            ...
                            let
                              ...
                              div
                                ...
                                <> display
          :examples $ []
        |comp-tag $ %{} :CodeEntry (:doc |) (:schema :dynamic)
          :code $ quote
          ...
          :code $ quote
            defstyle css-item-label $ {}
              |$0 $ {} (:font-weight 300) (:font-family ui/font-fancy) (:font-size 15) (:line-height |14px)
                :color $ hsl 0 0 60
          :examples $ []
        |css-placeholder $ %{} :CodeEntry (:doc |) (:schema :dynamic)
          :code $ quote
        ...
        |css-snippet $ %{} :CodeEntry (:doc |) (:schema :dynamic)
          :code $ quote
            defstyle css-snippet $ {}
              ...
              "|& > pre" $ {} (:margin 0)
          :examples $ []
        |css-tab $ %{} :CodeEntry (:doc |) (:schema :dynamic)
          :code $ quote
            defstyle css-tab $ {}
        ...
        |style-catoptric $ %{} :CodeEntry (:doc |) (:schema :dynamic)
          ...
          :examples $ []
        |style-close $ %{} :CodeEntry (:doc |) (:schema :dynamic)
          :code $ quote
        ...
        |style-copy-container $ %{} :CodeEntry (:doc |) (:schema :dynamic)
          ...
          :examples $ []
        |style-copy-outline $ %{} :CodeEntry (:doc |) (:schema :dynamic)
          :code $ quote
          ...
          :examples $ []
        |style-copy-wrapper $ %{} :CodeEntry (:doc |) (:schema :dynamic)
          :code $ quote
          ...
          :code $ quote
            defstyle style-tab-highlight $ {}
              ...
              (str |. style-tabs "|:hover &")
                {} $ :height 3
          :examples $ []
        |style-tab-vertical-highlight $ %{} :CodeEntry (:doc |) (:schema :dynamic)
          :code $ quote
            defstyle style-tab-vertical-highlight $ {}
              ...
              (str |. style-tabs "|:hover div&")
                {} $ :width 4
          :examples $ []
        |style-tabs $ %{} :CodeEntry (:doc |) (:schema :dynamic)
          :code $ quote
            defstyle style-tabs $ {}
              |& $ {} (:position :relative)
          :examples $ []
        |style-tag $ %{} :CodeEntry (:doc |) (:schema :dynamic)
          :code $ quote
            defstyle style-tag $ {}
          ...
          :examples $ []
        |style-tag-error $ %{} :CodeEntry (:doc |) (:schema :dynamic)
          :code $ quote
          ...
          :examples $ []
        |style-tag-info $ %{} :CodeEntry (:doc |) (:schema :dynamic)
          :code $ quote
          ...
          :examples $ []
        |style-tag-success $ %{} :CodeEntry (:doc |) (:schema :dynamic)
          :code $ quote
          ...
          :examples $ []
        |style-tag-warning $ %{} :CodeEntry (:doc |) (:schema :dynamic)
          :code $ quote
    ...
    |respo-ui.comp.container $ %{} :FileEntry
      :defs $ {}
        ...
        |comp-utils-page $ %{} :CodeEntry (:doc |) (:schema :dynamic)
          ...
          :examples $ []
        |css-content $ %{} :CodeEntry (:doc |) (:schema :dynamic)
          :code $ quote
    ...
    |respo-ui.comp.fonts-page $ %{} :FileEntry
      :defs $ {}
        |comp-fonts-page $ %{} :CodeEntry (:doc |) (:schema :dynamic)
          ...
          :examples $ []
        |css-demo $ %{} :CodeEntry (:doc |) (:schema :dynamic)
          :code $ quote
            defstyle css-demo $ {}
    ...
    |respo-ui.comp.layouts-page $ %{} :FileEntry
      :defs $ {}
        |comp-layouts-page $ %{} :CodeEntry (:doc |) (:schema :dynamic)
          :code $ quote
          ...
          :examples $ []
        |css-sample $ %{} :CodeEntry (:doc |) (:schema :dynamic)
          :code $ quote
            defstyle css-sample $ {}
              |$0 $ {} (:padding "|4px 8px") (:font-size 12) (:line-height |20px) (:font-family ui/font-code) (:border-radius |4px)
                ...
                :color $ hsl 0 0 30
          :examples $ []
        |render-demo $ %{} :CodeEntry (:doc |) (:schema :dynamic)
          :code $ quote
    ...
    |respo-ui.comp.sidebar $ %{} :FileEntry
      :defs $ {}
        |comp-sidebar $ %{} :CodeEntry (:doc |) (:schema :dynamic)
          ...
          :examples $ []
        |css-sidebar-entry $ %{} :CodeEntry (:doc |) (:schema :dynamic)
          :code $ quote
    ...
    |respo-ui.core $ %{} :FileEntry
      :defs $ {}
        ...
        |column-parted $ %{} :CodeEntry (:doc |) (:schema :dynamic)
          ...
          :examples $ []
        |default-fonts $ %{} :CodeEntry (:doc |) (:schema :dynamic)
    ...
    |respo-ui.css $ %{} :FileEntry
      :defs $ {}
        ...
        |button-danger $ %{} :CodeEntry (:doc |) (:schema :dynamic)
          ...
          :examples $ []
        |button-danger-outline $ %{} :CodeEntry (:doc |) (:schema :dynamic)
          :code $ quote
        ...
        |fullscreen $ %{} :CodeEntry (:doc |) (:schema :dynamic)
          ...
          :examples $ []
        |gap16 $ %{} :CodeEntry (:doc |) (:schema :dynamic)
          :code $ quote
            defstyle gap16 $ {}
              |& $ {} (:gap 16)
          :examples $ []
        |gap8 $ %{} :CodeEntry (:doc |) (:schema :dynamic)
          :code $ quote
            defstyle gap8 $ {}
              |& $ {} (:gap 8)
          :examples $ []
        ...
        |link $ %{} :CodeEntry (:doc |) (:schema :dynamic)
          ...
          :examples $ []
        |link-slight $ %{} :CodeEntry (:doc |) (:schema :dynamic)
          :code $ quote
            defstyle link-slight $ {}
              ...
              |$0:active $ {}
                ...
                :transform "|scale(1.04)"
          :examples $ []
        |preset $ %{} :CodeEntry (:doc |) (:schema :dynamic)
          :code $ quote
            defstyle preset $ {}
