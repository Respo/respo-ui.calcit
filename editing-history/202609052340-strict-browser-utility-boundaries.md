...
- Give `santinize-html-text` a concrete String-to-String contract so its replace chain specializes statically, and escape ampersands before angle brackets to preserve literal numeric/named entity text when HTML is parsed.
